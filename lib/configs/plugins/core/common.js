...
module.exports = {
  ...
  rules: {
    ...
    // TODO: ERROR for testing purpose, highly debatable
    'max-lines': [ERROR, {
      max: 500,
      skipBlankLines: true,
      skipComments: true,
    ...
    // Enforcing object desctructuring is highly debatable as it could lead to readability issues
    // Enforcing array desctructuring can cause issue when accessing a high index
